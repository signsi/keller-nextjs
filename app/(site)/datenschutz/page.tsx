    ...
    <section className="bg-white pt-10 pb-20">
      <Container>
        <nav className="flex items-center gap-1.5 text-xs text-[var(--text-tertiary)] mb-8">
          ...
          <span>/</span>
          <span className="text-[var(--text-secondary)]">Datenschutz</span>
        </nav>
        ...
        <div className="max-w-2xl">
          ...
          <div className="space-y-8 text-sm text-[var(--text-secondary)] leading-relaxed">
            ...
            <div>
              ...
              <p className="mt-2 font-semibold text-[var(--text-primary)]">Keller Galvanik AG</p>
            ...
            <div className="pt-2">
              <p className="text-xs text-[var(--text-tertiary)]">Stand: {new Date().toLocaleDateString('de-CH', { year: 'numeric', month: 'long' })}</p>
            </div>
