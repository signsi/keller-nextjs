...
export default function HomeSurfacePartner({ settings }: Props) {
  ...
  return (
    <section className="bg-brand-800 py-16 lg:py-24">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="max-w-xl">
            <p className="text-sm font-medium text-white/70 mb-5">{companyName}</p>
            <h2 className="text-5xl sm:text-6xl font-bold leading-[0.98] tracking-[-0.03em] text-white">
              Ihr Partner für Oberflächen
            </h2>

            <p className="mt-7 text-xl sm:text-2xl leading-[1.45] tracking-[-0.015em] text-white/88">
            ...
            <p className="mt-8 text-lg sm:text-xl leading-normal text-white/78">
            ...
            <div className="mt-10">
              <Link
                href="/ueber-uns"
                className="ui-button h-12 px-7 text-base border border-white/25 bg-white/10 text-white hover:bg-white/20"
              >
                Über uns
              </Link>
            </div>
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-[22px] border border-white/20 bg-white/10 aspect-16/10">
              <Image
